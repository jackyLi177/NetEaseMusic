...
public class Downloader {
    ...
    File download(String url, File dstFile) throws MalformedURLException {
        return download(new URL(url), dstFile);
    }
    ...
    static private class FileDownloadResponseHandler implements ResponseHandler<File> {
